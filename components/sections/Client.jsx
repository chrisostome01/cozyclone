...
export default function Client() {
    return (
        <div className="py-[140px] px-6 bg-[#e4ded5]">
                ...
                <div className="relative w-5/6 mx-auto ">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        <div className="m-[15px] bg-hero bg-3.1 self-end py-20 px-10 bg-[#223240] flex flex-col rounded-client-one shadow-client-one">
                            ...
                            {/* description */}
                            <div className="mb-[15px] text-[#e4ded5] font-normal font-fraunces72 leading-[1.6em] text-[18px] text-right">
                            ...
                            {/* client info */}
                            <div className=" tracking-[4px] uppercase font-bold text-[#e4ded5] text-right font-geomanist text[12px]">
                                Susie Pollasky
                            </div>
                            <div className=" font-geomanist text-[#e4ded5] text-[12px] font-normal text-right">
                        ...
                        <div className="lg:pr-[100px]">
                            <div className="m-[15px] bg-hero bg-3.1 py-20 px-10 bg-[#2d4850] flex flex-col rounded-client-two shadow-client-two">
                                ...
                                {/* description */}
                                <div className="mb-[15px] text-[#e4ded5] font-normal font-fraunces72 leading-[1.6em] text-[18px] text-left">
                                ...
                                {/* client info */}
                                <div className=" tracking-[4px] uppercase font-bold text-[#e4ded5] text-left font-geomanist text[12px]">
                                    Martin Spritzer
                                </div>
                                <div className=" font-geomanist text-[#e4ded5] text-[12px] font-normal text-left">
                    ...
                    <div className="absolute left-0 right-0 z-40  m-auto -translate-y-1/2 top-[58%] w-28 h-28 border border-[#e4ded5] rounded-full p-[1px] hidden lg:flex items-center justify-center shadow-circle">
                        <div className="flex items-center justify-center w-20 h-20 bg-[#e4ded5] rounded-full shadow-circle">
